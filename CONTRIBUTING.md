# Welcome to PD-47 Contributing Guide

Thank you for investing your time in contributing to PD-47!

This guide aims to provide an overview of the contribution workflow to help us make the contribution process effective for everyone involved.

## About the Project

PD-47 is a minimal and forkable repo providing builders with a starter kit to build decentralized applications on Ethereum.

Read the [README](README.md) to get an overview of the project.

### Vision

The goal of PD-47 is to provide the primary building blocks for a decentralized application.
